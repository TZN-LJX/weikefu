...
describe('OnboardingPage', () => {
  it('only offers settings and private pack import before content is available', async () => {
    const onImport = vi.fn()
    const user = userEvent.setup()
    render(<OnboardingPage onImport={onImport} onOpenSettings={vi.fn()} importing={false} />)
